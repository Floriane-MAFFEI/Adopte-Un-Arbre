...
{
    #[Route('/', name: 'app_back_project_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_back_project_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_back_project_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_back_project_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_back_project_delete', methods: ['POST'])]
